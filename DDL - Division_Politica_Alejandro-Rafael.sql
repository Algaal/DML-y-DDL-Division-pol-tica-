-- Tller 5 / punto 7 / DDL modificado por:
-- Alejandro Gallego Alarcón
-- Rafael Angel Aleman Castillo
...
-- Consultar tabla de monedas	
SELECT *
	FROM moneda
;

-- Consultar tabla de los paises
SELECT *
	FROM Pais
;

-- Consultar tabla de monedas y paises juntas
SELECT *
	FROM moneda M
		JOIN pais P
			ON M.id=P.idmoneda
